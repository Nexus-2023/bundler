...
async function encodeUserOperationData(
  ...
  functionParams: any[]
    ...
    const value = ethers.utils.parseUnits(functionParams[1], decimals);

    functionParams[1] = value;
...
async function main(): Promise<void> {
    ...
    let FUNCTION_PARAMS: any[] = ["0x2D136A987b991D28aAeE079f574330bFF4DA1ed8", "0.0001"];
